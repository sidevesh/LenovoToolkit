...
namespace LenovoToolkit
{
    ...
    public partial class App : Application
    {
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            {
                MessageBox.Show("PowerBattery.dll has to be present in the same folder as LenovoToolkit.exe", "", MessageBoxButton.OK, MessageBoxImage.Asterisk);
                Application.Current.Shutdown();
            }
